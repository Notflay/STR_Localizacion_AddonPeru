...
BEGIN
   ...
   SELECT 'No es posible anular el número ' || :pv_TipoSunat || '-' || :pv_SerieSunat || '-' || :pv_NumSunat || ' porque este ya se encuentra registrado en un documento del sistema o ya está anulado.'
	FROM (
